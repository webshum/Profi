<?php $__env->startSection('content'); ?>
    ...
    <?php if(!isArrayEmpty(get_field('faq'))): ?> 
        <div class="fancy-gallery py-[150px]">
            <div class="center">
                <?php if(!empty(get_field('faq')['title'])): ?>
        		...
        		<?php if(!empty(get_field('faq')['item'])): ?>
        		<div class="gallery-wrap">
        		    <?php $__currentLoopData = get_field('faq')['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        		    <?php 
        		        $link = '';
                        ...
                        <ul class="splide__list">
                            <?php while($products->have_posts()): ?>
                                ...
                                <li class="splide__slide">
                                    <?php echo $__env->make('partiales.product-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </li>
                            <?php endwhile; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/serhi/Sites/Profi/public/themes/sage/resources/views/front-page.blade.php ENDPATH**/ ?>